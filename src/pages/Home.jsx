...
const Home = () => {
  ...
  const updateHandler=async(id,currentStatus)=>{
    try {
      const {data}=await axios.put(`${server}/tasks/${id}/toogle`,{isCompleted: !currentStatus},{
    ...
    <div className="container">
      ...
      <section>
        <form onSubmit={submitHandler}>
            ...
            <button type='submit' disabled={loader}>Add Task</button>
      ...
      <section className="todosContainer">
        {tasks.map((task) => (
          ...
          updateHandler={updateHandler} deleteHandler={deleteHandler} id={task._id} key={task._id}
          />
        ))}
      </section>
    </div>
